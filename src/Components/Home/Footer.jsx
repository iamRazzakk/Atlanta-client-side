...
const Footer = () => {
    return (
        <div>
            <footer className="footer font-Bricolage p-10 bg-slate-100 text-base-content">
                <nav>
                    <h6 className="text-[33px] leading-[63px]">Services</h6>
                    <a className="link link-hover text-[21px]">Branding</a>
                    <a className="link link-hover text-[21px]">Design</a>
                    <a className="link link-hover text-[21px]">Marketing</a>
                    <a className="link link-hover text-[21px]">Advertisement</a>
                </nav>
                <nav>
                    <h6 className="text-[33px] leading-[63px]">Company</h6>
                    <a className="link link-hover text-[21px]">About us</a>
                    <a className="link link-hover text-[21px]">Contact</a>
                    <a className="link link-hover text-[21px]">Jobs</a>
                    <a className="link link-hover text-[21px]">Press kit</a>
                </nav>
                <nav>
                    <h6 className="text-[33px] leading-[63px]">Social</h6>
            ...
            <footer className="footer items-center  p-4 font-Lato text-black">
                <aside className="items-center text-center grid-flow-col">
