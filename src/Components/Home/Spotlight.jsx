...
const Spotlight = () => {
    return (
        <div className="md:mt-32">
            <div className="md:h-[392px] bg-[#FFC300] rounded-bl-2xl md:mb-32 flex items-center justify-center">
                <div className="grid grid-cols-1 text-left md:grid-cols-2 gap-4 m-auto w-full md:ml-10 lg:grid-cols-4">
                    <div>
